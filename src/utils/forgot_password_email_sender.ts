...
async function sendForgotPasswordEmail(username: string, email: string, randomCode: string) {
    ...
    >
      <div
        style="
          text-align: center;
          padding: 20px;
          background-color:rgb(202, 83, 62);
          border-radius: 6px;
          color: #fff;
        "
      >
      ...
      <div style="padding: 20px; text-align: center;">
        <p style="font-size: 18px; color: #333; margin-bottom: 20px;">
          Hurmatli ${(username || "Foydalanuvchi").toUpperCase()}, parolingizni tiklash uchun quyidagi
